    ...
    <article class="skyvape-footer-company">
      <section>
        ...
        <div class="skyvape-footer-privacy">
          <RouterLink to="/company-intro">회사소개</RouterLink>
          <RouterLink to="/company-terms">이용약관</RouterLink>
          <RouterLink to="/company-privacy">개인정보처리방침</RouterLink>
          <RouterLink to="/company-use">이용안내</RouterLink>
        </div>
      </section>
    </article>
  </footer>
